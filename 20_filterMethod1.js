...
const arrayTcsEmployees = array_employees.filter( (employee) => {  // to get desired array filter out array.
    return employee.emp_company == "TCS";
} );
const arrayTcsEmployeeNames = arrayTcsEmployees.map( (employee) => { // array travesing
